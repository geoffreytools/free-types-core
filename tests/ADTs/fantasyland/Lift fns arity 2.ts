...
test('Either fmap(monomorphic): is OK but too wide', t => [
...
test('fmap(monomorphic) composition: is OK', t => [
...
test('LiftA2(monomorphic): is OK', t => [
...
test('LiftA2(polymorphic): is OK', t => 
    // @ts-expect-error: *
...
test('liftA2(monomorphic) composition: is OK', t =>
